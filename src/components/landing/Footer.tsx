...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Mail, href: "mailto:hello@smartlearning.com", label: "Email" },
  ];
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-muted-foreground text-sm mb-4 max-w-xs">
              AI-powered education platform for teachers and students. 
              Transform learning with intelligent tutoring and analytics.
            </p>
